...
class Customer:
    ...
    def get_wallet_coin(self, coin_name):
        ...
        # I think this is where the bug is, in this method. the problem is that when i choose a dime, it think its worth 25 cents and i have no idea why, i've tried very hard to figure it out but i can't
    ...
    def check_backpack(self):
        ...
        if len(self.backpack.purchased_cans) <= 0:
            ...
            for can in self.backpack.purchased_cans:
                user_interface.output_text(can)
